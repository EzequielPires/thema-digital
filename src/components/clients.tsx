        ...
        <div className="w-full max-w-7xl mx-auto px-4 lg:px-0">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4">
            <div className="h-32 lg:h-52 flex items-center justify-center group border-white/10 border-r border-b">
              <Image src={'/brands/logo_01.svg'} alt="" width={100} height={40} className="group-hover:w-[0] transition-all absolute" data-aos="zoom-in" data-aos-delay="50"/>
            ...
            <div className="h-32 lg:h-52 flex items-center justify-center group border-white/10 lg:border-r border-b">
              <Image src={'/brands/logo_02.svg'} alt="" width={100} height={40} className="group-hover:w-[0] transition-all absolute"  data-aos="zoom-in" data-aos-delay="100"/>
              <Link href={'/'} className="w-0 group-hover:w-fit overflow-hidden transition-all font-medium">CICLO</Link>
            </div>
            <div className="h-32 lg:h-52 flex items-center justify-center group border-white/10 border-r border-b">
              <Image src={'/brands/logo_03.svg'} alt="" width={100} height={40} className="group-hover:w-[0] transition-all absolute"  data-aos="zoom-in" data-aos-delay="150" />
            ...
            <div className="h-32 lg:h-52 flex items-center justify-center group border-white/10 border-b">
              <Image src={'/brands/logo_04.svg'} alt="" width={100} height={40} className="group-hover:w-[0] transition-all absolute" data-aos="zoom-in" data-aos-delay="200"/>
            ...
            <div className="h-32 lg:h-52 flex items-center justify-center group border-white/10 border-b lg:border-b-0 border-r" >
              <Image src={'/brands/logo_05.svg'} alt="" width={100} height={40} className="group-hover:w-[0] transition-all absolute" data-aos="zoom-in" data-aos-delay="50"/>
            ...
            <div className="h-32 lg:h-52 flex items-center justify-center group border-white/10 border-b lg:border-b-0 lg:border-r" >
              <Image src={'/brands/logo_06.svg'} alt="" width={100} height={40} className="group-hover:w-[0] transition-all absolute" data-aos="zoom-in" data-aos-delay="100"/>
            ...
            <div className="h-32 lg:h-52 flex items-center justify-center group border-white/10 border-r">
              <Image src={'/brands/logo_07.svg'} alt="" width={100} height={40} className="group-hover:w-[0] transition-all absolute" data-aos="zoom-in" data-aos-delay="150" />
            ...
            <div className="h-32 lg:h-52 flex items-center justify-center group border-white/10">
              <Image src={'/brands/logo_06.svg'} alt="" width={100} height={40} className="group-hover:w-[0] transition-all absolute" data-aos="zoom-in" data-aos-delay="200" />
              <Link href={'/'} className="w-0 group-hover:w-fit overflow-hidden transition-all font-medium">CEPESQ</Link>
            </div>
          </div>
        </div>
