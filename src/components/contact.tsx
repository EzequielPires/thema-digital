...
export function Contact() {
  return (
    <div className="h-[50vh] lg:h-[80vh] bg-background">
      <div className="w-full max-w-7xl mx-auto px-4 lg:px-0 flex items-center h-full py-10 gap-10">
        <div className="flex-1 flex flex-col items-center">
          ...
          <h2 className="text-3xl lg:text-5xl title text-center mb-6 lg:mb-16 max-w-4xl">Nos conte sobre o seu próximo projeto.</h2>
