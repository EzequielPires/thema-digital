    ...
    return (
        ...
        <div className="w-full max-w-7xl mx-auto px-4 lg:px-0 flex items-center h-full py-10 gap-10">
          <div className="flex-1 flex flex-col items-center">
            ...
            <h2 className="text-4xl lg:text-7xl text-center title mb-4 stroke-slate-500 stroke-2"><span className="text-with-stroke title text-zinc-900">nos conte sobre</span> o seu próximo projeto<span className="text-with-stroke text-zinc-900">.</span></h2>
